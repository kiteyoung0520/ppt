  ...
  return (
    <div className="w-full min-h-[100dvh] bg-[#0f172a] relative flex items-center justify-center p-0 lg:p-6 overflow-hidden">
      ...
      `}>
        ...
        <div className="shrink-0 flex items-center px-3 sm:px-6 py-1.5 sm:py-3 border-b border-white/10 gap-2 sm:gap-4 bg-black/5">
          <div className="flex items-center gap-1.5 sm:gap-3 flex-1 min-w-0">
             <div className="flex flex-col">
                <span className="hidden xs:block text-[7px] sm:text-[10px] font-black text-emerald-400 uppercase tracking-widest leading-none mb-0.5">Guardian</span>
                <span className="text-[10px] sm:text-sm font-black text-white truncate drop-shadow-md">
                   {currentUser}
                </span>
             </div>
        ...
        <div className="flex-1 overflow-y-auto p-0 sm:p-8 custom-scroll bg-gradient-to-b from-transparent to-black/20">
